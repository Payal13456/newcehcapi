              ...
              <tr>
                <td style="padding:35px 70px 30px;" class="em_padd" valign="top" bgcolor="#fff" align="center">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                   <tbody>
                     <tr>
                        <td style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:30px; " valign="top" align="left">Hello <b> {{$user['first_name']}} </b></td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        <td style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:30px; " valign="top" align="left">Greetings from Dr Ashok Eye Hospital.</td>
                     </tr>
                     <tr>
                          <td style="font-size:0px; line-height:0px; height:15px;" height="15">&nbsp;</td>
                     </tr>
                     <tr>
                          <td style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px;  padding-bottom:12px;" valign="top" align="left">Welcome to CEHC App, We are happy to see you here</td>
                     </tr>
                     <tr>
                          <td class="em_h20" style="font-size:0px; line-height:0px; height:25px;" height="25">&nbsp;</td>
                     </tr>
                     <tr>
                          <td style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px;  padding-bottom:12px;" valign="top" align="left">You can access our web portal as well with the following credentials. </td>
                     </tr>
                     <tr>
                          <td class="em_h20" style="font-size:0px; line-height:0px; height:25px;" height="25">&nbsp;</td>
                      </tr>
                      @if($user['role_id'] == 1)
                      <tr>
                          <td style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px;  padding-bottom:12px;" valign="top" align="left"><p>Click Here to login - <a href="https://cehcapp.tryambaka.com" target="_blank"></p><p>Username - {{$user['email']}}</p><p>Password - {{$user['password']}}</p></td>
                      </tr>
                      <tr>
                          <td class="em_h20" style="font-size:0px; line-height:0px; height:25px;" height="25">&nbsp;</td>
                      </tr>
