                ...
                <td style="padding:35px 70px 30px;" class="em_padd" valign="top" bgcolor="#fff" align="center">
                  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                   <tbody>
                     ...
                     <tr>
                          <td style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px;  padding-bottom:12px;" valign="top" align="left">This is to confirm that you have rescheduled your appointment with Dr {{$doctor->first_name}} {{$doctor->last_name}} on {{date("d M Y", strtotime($date))}} at {{date("H:i A",strtotime($time))}}</td>
                     </tr>
                     <tr>
                          <td class="em_h20" style="font-size:0px; line-height:0px; height:25px;" height="25">&nbsp;</td>
                     </tr>
                     <tr>
                          <td style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px;  padding-bottom:12px;" valign="top" align="left">Login to our app to cancel or change appintment.</td>
                     </tr>
                     <tr>
                          <td class="em_h20" style="font-size:0px; line-height:0px; height:25px;" height="25">&nbsp;</td>
                     </tr>
                     <tr>
                          <td style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:22px;  padding-bottom:12px;" valign="top" align="left">You will be sent a reminder message 1 day before the appointment date.</td>
                     </tr>
                     <tr>
                          <td class="em_h20" style="font-size:0px; line-height:0px; height:25px;" height="25">&nbsp;</td>
                     </tr>
